...
const AlchemicalCasteSelect = (props: TextFieldProps) => (
  ...
  >
    ...
    <MenuItem key="orichalcum" value="orichalcum">
      Orichalcum
    </MenuItem>
    <MenuItem key="moonsilver" value="moonsilver">
      Moonsilver
    </MenuItem>
    <MenuItem key="starmetal" value="starmetal">
      Starmetal
    </MenuItem>
    <MenuItem key="jade" value="jade">
      Jade
    </MenuItem>
    <MenuItem key="soulsteel" value="soulsteel">
      Soulsteel
    </MenuItem>
    <MenuItem key="adamant" value="adamant">
      Adamant
    </MenuItem>
  </TextField>
)
