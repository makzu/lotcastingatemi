...
import { takeDamage } from 'ducks/events/index.ts'
import HealthLevelBoxes from './HealthLevelBoxes.tsx'
...
const connector = connect(mapStateToProps, { takeDamage })
type PropsFromRedux = ConnectedProps<typeof connector>

export default connector(DamageWidget)
