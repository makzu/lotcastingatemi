...
export default function PrivacyPage() {
  return <BlockPaper>
    ...
    <Typography paragraph>
      I will never use your email address for anything other than authentication.
      Period. Your personal information will never be sold or otherwise transferred
      to anyone else, except in the case where LCA changes hosting providers (and
      then only as needed to facilitate that transfer), or when compelled to by
    ...
    <Typography paragraph>
      Lot-Casting Atemi uses Cookies and similar techniques to help the site work
      better. If you have Cookies disabled, portions of the site might not work.
    </Typography>

    <Typography variant="subheading">
      Service Providers
    </Typography>
    <Typography paragraph component="a" href="https://www.heroku.com/policy/security">
