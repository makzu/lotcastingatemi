import type { PlayerAsset, Timing, Weight, WithId } from '@/types/_lib'
...
export interface NativeCharm extends Charm {
  ability: Ability | Attribute | 'universal' | ''
  min_ability: number
}

export interface MartialArtsCharm extends Charm {
  charm_type: 'MartialArts'
  min_ability: number
  style: string
}

export interface Evocation extends CharacterTrait {
