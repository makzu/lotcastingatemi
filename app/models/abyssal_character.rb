...
# Traits and Validations specific to Abyssals.
class AbyssalCharacter < Character
  ...
  attribute :exalt_type,               :string,  default: 'Abyssal'
  ...
  validates :caste, inclusion: { in: ABYSSAL_CASTES }, unless: :caste_is_blank?
  ...
  def self.from_character!(character)
    new_cha = character.becomes(AbyssalCharacter)
    new_cha.type = 'AbyssalCharacter'
