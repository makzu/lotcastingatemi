...
class Character < ApplicationRecord
  ...
  def self.from_character!(character) # rubocop:disable Metrics/AbcSize
    ...
    new_cha.supernal_ability = new_cha.limit = new_cha.limit_trigger = new_cha.active_loadout = nil
