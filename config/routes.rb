...
Rails.application.routes.draw do
  ...
  get 'cypress_token', to: 'sessions#cypress_token' unless Rails.env.production?
  ...
  namespace :api do
    namespace :v1 do
      ...
      resources :chronicles, only: %i[create show update destroy] do
        member do
          get  'characters',                         action: :characters
          get  'qcs',                                action: :qcs
          get  'battlegroups',                       action: :battlegroups
