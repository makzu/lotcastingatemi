...
ActiveRecord::Schema.define(version: 20170311054129) do
  ...
  create_table "armors", force: :cascade do |t|
    ...
    t.index ["character_id"], name: "index_armors_on_character_id", using: :btree
  end
  ...
  create_table "merits", force: :cascade do |t|
    ...
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
    t.index ["character_id"], name: "index_merits_on_character_id", using: :btree
  end

  create_table "qc_merits", force: :cascade do |t|
    t.integer  "qc_id"
    t.string   "name"
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.index ["qc_id"], name: "index_qc_merits_on_qc_id", using: :btree
  end
