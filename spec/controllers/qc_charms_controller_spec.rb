...
RSpec.describe Api::V1::QcCharmsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'With valid attributes' do
      it 'Increases merit count by 1' do
        ...
        expect { post :create, params: { qc_id: @qc.id, qc_merit: @qc_merit_params }, format: :json }.to change(QcCharm, :count).by(1)
      end
    end
    ...
    context 'With invalid attributes' do
      it 'Increases merit count by 0' do
        ...
        expect { post :create, params: { qc_id: @qc.id, qc_merit: @invalid_merit_params }, format: :json }.to change(QcCharm, :count).by(0)
      end
    end
  ...
  describe 'DELETE #destroy' do
    it 'Decreases merit count by 1' do
      request.headers['Authorization'] = authenticated_header(@player)
      expect { delete :destroy, params: { qc_id: @qc_merit.qc_id, id: @qc_merit.id, format: :json } }.to change(QcCharm, :count).by(-1)
    end
